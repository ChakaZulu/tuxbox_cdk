...
yadd-none: bare-os config tuxbox_tools procps ftpd yadd-ucodes yadd-bootlogos @AUTOMOUNT@ @LIRC@ @CDKVCINFO@ @XFSPROGS@ @NFSSERVER@ @SAMBASERVER@ @LUFS@ @SMBMOUNT@ @REISERFSPROGS@ @CONSOLE_TOOLS@ @OPENVPN@ version defaultlocale
	@TUXBOX_YADD_CUSTOMIZE@
