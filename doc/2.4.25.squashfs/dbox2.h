 ...
 */
/*
 * booting JFFS2only img. (2xflash)
 */
#define	CONFIG_BOOTCOMMAND								\
	"fsload; protect off 10020000 107fffff; "						\
	"setenv bootargs root=/dev/mtdblock3 rootfstype=squashfs console=$(console); "			\
	"bootm"


#define 	CONFIG_BAUDRATE		9600	/* console baudrate = 9.6kbps*/
//#define	CFG_LOADS_BAUD_CHANGE		/* don't allow baudrate change */
...
#define	CONFIG_DBOX2_FS_ENV_READ		"1:tuxbox/boot/ppcboot.conf"
#define CONFIG_EXTRA_ENV_SETTINGS		"console=ttyS0\0"
...
#define	CONFIG_AUTOBOOT_SELECT		0
#define	CONFIG_AUTOBOOT_SELECT_AUTOBOOT	0
