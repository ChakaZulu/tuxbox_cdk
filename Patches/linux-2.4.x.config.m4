...
ifdef(`TARGETRULESET_IDE2',`
#
# ATA/IDE/MFM/RLL support
#
option(`CONFIG_IDE',`m',`m')

#
# IDE, ATA and ATAPI Block devices
#
option(`CONFIG_BLK_DEV_IDE',`m',`y')
...
# ATA/IDE/MFM/RLL support
#
option(`CONFIG_IDE',`m',`n')

#
# IDE, ATA and ATAPI Block devices
#
option(`CONFIG_BLK_DEV_IDE',`m',`n')
')
...
ifdef(`TARGETRULESET_IDE2',`
option(`CONFIG_BLK_DEV_IDEDISK',`m',`y')
',`
option(`CONFIG_BLK_DEV_IDEDISK',`m',`n')
')
...
ifdef(`TARGETRULESET_IDE2',`
option(`CONFIG_BLK_DEV_IDECD',`m',`y')
',`
option(`CONFIG_BLK_DEV_IDECD',`m',`n')
')
...
ifdef(`TARGETRULESET_IDE2',`
option(`CONFIG_EXT3_FS',`m',`y')
option(`CONFIG_JBD',`m',`y')
option(`CONFIG_JBD_DEBUG',`n',`n')
option(`CONFIG_FAT_FS',`m',`y')
option(`CONFIG_MSDOS_FS',`m',`y')
option(`CONFIG_UMSDOS_FS',`n',`n')
option(`CONFIG_VFAT_FS',`m',`y')
',`
option(`CONFIG_EXT3_FS',`n',`n')
option(`CONFIG_JBD',`n',`n')
option(`CONFIG_JBD_DEBUG',`n',`n')
option(`CONFIG_FAT_FS',`n',`n')
option(`CONFIG_MSDOS_FS',`n',`n')
option(`CONFIG_UMSDOS_FS',`n',`n')
option(`CONFIG_VFAT_FS',`n',`n')
')
...
ifdef(`TARGETRULESET_IDE2',`
option(`CONFIG_EXT2_FS',`m',`y')
',`
option(`CONFIG_EXT2_FS',`n',`n')
')
